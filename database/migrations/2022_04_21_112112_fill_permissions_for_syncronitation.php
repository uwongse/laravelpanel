...
class FillPermissionsForSyncronitation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSyncronitation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.syncronitation',
            'admin.syncronitation.index',
            'admin.syncronitation.create',
            'admin.syncronitation.show',
            'admin.syncronitation.edit',
            'admin.syncronitation.delete',
            'admin.syncronitation.bulk-delete',
        ]);
