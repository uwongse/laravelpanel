...
class FillPermissionsForDirector extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDirector constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.director',
            'admin.director.index',
            'admin.director.create',
            'admin.director.show',
            'admin.director.edit',
            'admin.director.delete',
            'admin.director.bulk-delete',
        ]);
