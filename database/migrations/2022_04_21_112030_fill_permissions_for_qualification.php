...
class FillPermissionsForQualification extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForQualification constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.qualification',
            'admin.qualification.index',
            'admin.qualification.create',
            'admin.qualification.show',
            'admin.qualification.edit',
            'admin.qualification.delete',
            'admin.qualification.bulk-delete',
        ]);
