...
class FillPermissionsForProjection extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjection constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.projection',
            'admin.projection.index',
            'admin.projection.create',
            'admin.projection.show',
            'admin.projection.edit',
            'admin.projection.delete',
            'admin.projection.bulk-delete',
        ]);
